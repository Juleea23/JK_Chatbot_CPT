...
# Pfade
# wenn Embeddings neu erstellt werden sollen, dann gesamten Ordner vector_db löschen!
...
def query():
    try:
        ...
        prompt_text = f"""
        Du bist ein Assistent für politische Bildung. Fasse die Position der Partei '{party}' zum Thema '{topic}' in maximal 5 Sätzen zusammen. Beachte dabei folgende Regeln: 1. Beachte dabei nur ganze Sätze. 2. Nenne ausschließlich Informationen, die in den Auszügen vorhanden sind.
